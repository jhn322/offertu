...
function Calendar({
  ...
  const buttonRangeClassName =
    'bg-secondary [&>button]:bg-primary [&>button]:text-primary-foreground [&>button]:hover:bg-primary [&>button]:hover:text-primary-foreground';
  ...
  const _outsideClassName = cn(
    'day-outside text-muted-foreground opacity-60 aria-selected:bg-secondary/60 aria-selected:text-muted-foreground aria-selected:opacity-60',
